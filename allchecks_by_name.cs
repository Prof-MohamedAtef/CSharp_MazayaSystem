...
{
    public partial class allchecks_by_name : Form
    {
        public allchecks_by_name()
        {
            InitializeComponent();
        }
        ...
        private void allchecks_by_name_Load(object sender, EventArgs e)
        {
    ...
    var prev = mob_sys.Sale_checks.Where(s => s.Sale_To == Class1.Saleto).Select(s => new
            {
                s.ID,
                s.Notes,
                s.Sale_To,
