...
{
    public partial class report_day_sale : Form
    {
        DataClasses1DataContext mob_sys = new DataClasses1DataContext();
        DataTable dt = new DataTable();
        DataTable dt2 = new DataTable();
        public report_day_sale()
        {
            InitializeComponent();
        }

        private void report_day_sale_Load(object sender, EventArgs e)
        {
            ...
            int i = 1;
            var x = mob_sys.sale_checks_date(System.DateTime.Now.Date).ToList();
        ...
        private void dataGridView1_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            var x = mob_sys.sale_details(id).ToList();
            int i = 1;
            foreach (var item in x)
            {
