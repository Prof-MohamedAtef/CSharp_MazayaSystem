...
{
    public partial class report_day_return : Form
    {
        DataClasses1DataContext mob_sys = new DataClasses1DataContext();
        DataTable dt = new DataTable();
        DataTable dt2= new DataTable();
        public report_day_return()
        {
            InitializeComponent();
        }

        private void report_day_return_Load(object sender, EventArgs e)
        {
            ...
            int i = 1;
            var x = mob_sys.return_checks_date(System.DateTime.Now.Date).ToList();
        ...
        private void dataGridView1_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            var x = mob_sys.return_details(id).ToList();
            int i = 1;
            foreach (var item in x)
            {
