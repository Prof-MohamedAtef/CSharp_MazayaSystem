...
{
    public partial class Used_report_day_purch : Form
    {
        DataClasses1DataContext mob_sys = new DataClasses1DataContext();
        DataTable dt = new DataTable();
        DataTable dt2 = new DataTable();

        public Used_report_day_purch()
        {
            InitializeComponent();

        }

        private void Used_report_day_purch_Load(object sender, EventArgs e)
        {
            ...
            int i=1;
          var x=  mob_sys.Used_purch_checks_date(System.DateTime.Now.Date).ToList();
            foreach (var item in x)
	{
        ...
        private void dataGridView1_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            var x = mob_sys.Used_purch_details(id).ToList();
            int i = 1;
            foreach (var item in x)
            {
